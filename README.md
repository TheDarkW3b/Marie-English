...
Can be found on telegram as [Marie](https://t.me/BanhammerMarie_bot). Edited and transformed into [@MenherachanRoBot](https://t.me/Menherachanrobot)
...
class Development(Config):
    ...
    SUDO_USERS = [686021814]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
